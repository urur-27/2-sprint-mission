...
public class UserController {
  ...
  public ResponseEntity<ApiResponse<Void>> updateUser(@RequestBody UserUpdateRequest request) {
    ...
    return ResponseEntity.ok(
        new ApiResponse<>("User \"" + request.username() + "\" information has been modified.",
            null));
  }
  ...
  public ResponseEntity<ApiResponse<List<UserDto>>> getUsers() {
    ...
    ApiResponse<List<UserDto>> response = new ApiResponse<>(
        "Successfully found all user information", users);
  ...
  public ResponseEntity<ApiResponse<Void>> updateOnlineStatus(@PathVariable UUID id) {
    ...
    return ResponseEntity.ok(
        new ApiResponse<>("\"" + name + "\" online status has been updated.", null));
  }
